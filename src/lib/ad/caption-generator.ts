import { getPillarTitle as getPillarTitleFromConstants } from "../knowledge/constants";
...
export function buildFullPostText(
  ...
  if (platform === "x") {
    ...
    return sanitizeNoEmDash([body, hashtagPart, urlPart].filter(Boolean).join(" "));
  }
